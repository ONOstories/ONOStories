      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg mb-8">
            ...
            <span className="text-purple-600 font-medium">Choose Your Plan</span>
          </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed">
              Try ONOSTORIES risk-free! If you're not completely satisfied with your Pro subscription 
